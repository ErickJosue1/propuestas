                        ...
                        <table class="table-auto border-collapse w-full">
                            <thead>
                                <tr class="rounded-lg text-sm font-medium text-gray-700 text-left"
                                    ...
                                    <th class="px-4 py-2 bg-gray-200 " style="background-color:#f8f8f8">Descripcion de la convocatoria</th>
                                    <th class="px-4 py-2 bg-gray-200 " style="background-color:#f8f8f8">Status</th>
                                    <th class="px-4 py-2 bg-gray-200 " style="background-color:#f8f8f8">Fecha Captura</th>
                                    <th class="px-4 py-2 bg-gray-200 " style="background-color:#f8f8f8">Fecha Aprobado</th>
                            ...
                            <tbody class="text-sm font-normal text-gray-700">
                                <tr v-for="item in records" :key="item.id"
                                    ...
                                    <td class="px-4 py-4">Pendiente</td>
