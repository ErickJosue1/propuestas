...
<template>
    <LayoutMain>
        ...
        <CardBox v-else class="mb-6" has-table>
            ...
            <div v-if="(institutions.links.length - 2) > 1" class="p-3 lg:px-6 border-t border-gray-100 dark:border-slate-800">
                <BaseLevel>
                    <BaseButtons>
                        <BaseButton v-for="page in institutions.links.length - 2" :key="page"
                            :active="page === institutions.current_page" :label="page"
                            :href="institutions.links[page].url" @click="currentPage = page"
                            :color="page === currentPage ? 'lightDark' : 'whiteDark'" small />
                    </BaseButtons>
                    <small> Pagina {{ institutions.current_page }} de {{
                        institutions.links.length - 2
                    }}</small>
                </BaseLevel>
            </div>
        </CardBox>
