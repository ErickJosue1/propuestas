                        ...
                        <table class="table-auto border-collapse w-full">
                            ...
                            <tbody class="text-sm font-normal text-gray-700">
                                <tr v-for="item in institutions" :key="item.id"
                                    ...
                                    <td class="px-8 py-4">{{ item.status }}</td>
                                    <td class="px-4 py-4">
                                        <div class="inline-flex items-center rounded-md shadow-sm">
                                            <Link :href="route('institutions.edit', item.id)" class=" text-slate-800 hover:text-blue-600 text-sm bg-white
                                                hover:bg-slate-100 border border-slate-200 rounded-l-lg font-medium px-4
                                                py-2 inline-flex space-x-1 items-center">
