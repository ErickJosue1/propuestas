    ...
    setup() {
        ...
        const eliminar = (id) => {
            Swal.fire({
                ...
                if (res.isConfirmed) {
                    form.delete(route("fields.destroy", id));
                }
            });
        };
...
<template>
    <LayoutMain>
        ...
        <CardBox v-if="fields.data.length < 1">
            <CardBoxComponentEmpty />
        </CardBox>
        ...
        <CardBox v-else class="mb-6" has-table>
            <table>
                ...
                <tbody>
                    <tr v-for="item in fields.data" :key="item.id">
            ...
            <Pagination :currentPage="fields.current_page" :links="fields.links"
                :total="fields.links.length - 2"></Pagination>
        </CardBox>
