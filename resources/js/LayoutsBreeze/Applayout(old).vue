...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink v-if="useCan('institutions.index')" :href="route('institutions.index')"
                                    :active="route().current('institutions.index')">
                                    Instituciones
                                </NavLink>
                                <!--   <NavLink v-if="useCan('permissions.index')" :href="route('roles.index')"
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('institutions.index')"
                            :active="route().current('institutions.index')">
                            Instituciones
                        </ResponsiveNavLink>
                    </div>
            ...
            <!--   <div class="spinner-border text-success" style="width: 10rem; height: 10rem;">
            ...
            <aside id="logo-sidebar"
                ...
                <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a v-if="useCan('institutions.index')" :href="route('institutions.index')"
                                :active="route().current('institutions.index')"
                                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100">
                                <svg aria-hidden="true"
                        ...
                        <li>
                            <a v-if="useCan('permissions.index')" :href="route('permissions.index')"
                        ...
                        <li>
                            <a v-if="useCan('events.index')" :href="route('events.index')"
            ...
            <main>
                <div class=" sm:ml-64">
                    <div class="border-2 border-gray-200 border-dashed rounded-lg mt-2">
                        <slot />
